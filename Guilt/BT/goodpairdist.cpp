...
public:
    ...
    // Idea is to perform dfs & return a list of distances of all leaf nodes to
    // the ancestor and let the ancestor compare the distances of all it's leaf
    // nodes, add them to result
